...
const KunststofJaloezieeenPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          Kunststof Jaloezieën - Praktisch, Stijlvol en Vochtbestendig | KANIOU
          Zilvernaald
        </title>
        <meta
          name="description"
          content="Kunststof jaloezieën zijn een ideale keuze voor wie op zoek is naar een onderhoudsvriendelijke en vochtbestendige oplossing met een moderne uitstraling. Perfect voor keukens, badkamers of bedrijfsruimtes."
        />
      </Helmet>
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="text-center mb-16">
                ...
                <p className="text-lg text-text-light max-w-3xl mx-auto leading-relaxed">
                  Kunststof jaloezieën zijn een ideale keuze voor wie op zoek is
                  naar een onderhoudsvriendelijke en vochtbestendige oplossing
                  met een moderne uitstraling. Perfect voor keukens, badkamers
                  of bedrijfsruimtes.
                </p>
              </div>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  <Card className="hover:shadow-lg transition-shadow duration-300">
                    <CardContent className="p-6">
                      ...
                      <p className="text-text-light">
                        Gemaakt van duurzaam PVC of kunststof
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="hover:shadow-lg transition-shadow duration-300">
                    <CardContent className="p-6">
                      ...
                      <p className="text-text-light">
                        Beschikbaar in 25 mm, 35 mm en 50 mm lamelbreedte
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="hover:shadow-lg transition-shadow duration-300">
                    <CardContent className="p-6">
                      ...
                      <p className="text-text-light">
                        Budgetvriendelijk alternatief voor houten jaloezieën
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="hover:shadow-lg transition-shadow duration-300">
                    <CardContent className="p-6">
                      ...
                      <p className="text-text-light">
                        Leverbaar in effen kleuren en houtlook prints
                      </p>
                    </CardContent>
                  </Card>
                </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      <div className="bg-white p-6 rounded-lg shadow-sm border">
                        ...
                        <p className="text-text-light">
                          Kunststof in mat of glanzende afwerking
                        </p>
                      </div>
                      <div className="bg-white p-6 rounded-lg shadow-sm border">
                        <h3 className="text-xl font-semibold text-text-dark mb-3">
                        ...
                        <p className="text-text-light">
                          Wit, grijs, zwart, taupe, houtlook
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="bg-white p-6 rounded-lg shadow-sm border">
                        ...
                        <p className="text-text-light">
                          Ladderkoord (standaard) of ladderband (meerprijs)
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="bg-gradient-to-r from-secondary to-accent text-white p-8 rounded-lg mb-16">
                <div className="text-center">
                  ...
                  <p className="text-xl mb-2">Vanaf €135 per m²</p>
                  <p className="text-lg opacity-90">
                    Inclusief maatwerk en standaard montage. Prijs afhankelijk
                    van breedte, kleur en bedieningsoptie.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white p-8 rounded-lg shadow-lg border">
                <div className="text-center mb-8">
                  ...
                  <p className="text-lg text-text-light max-w-2xl mx-auto">
                    ...
                    persoonlijk adviesgesprek bij u thuis of in onze showroom.
                  </p>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-6 max-w-2xl mx-auto">
                  ...
                  <Link href="/contact">
                    <Button
                      variant="outline"
                      className="w-full border-secondary text-secondary hover:bg-secondary hover:text-white py-3 text-lg font-semibold transition-colors duration-300"
                    >
