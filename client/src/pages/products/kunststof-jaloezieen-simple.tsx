...
const KunststofJaloezieeenSimplePage = () => {
  return (
    <>
      <Helmet>
        <title>Kunststof jaloezieën - Praktische Kunststof Jaloezieën | Kaniou Zilvernaald</title>
        <meta
          name="description"
          content="Kunststof jaloezieën van Kaniou Zilvernaald - onderhoudsarme en vochtbestendige raamdecoratie. Ontdek onze collectie kunststof jaloezieën."
        />
      </Helmet>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-[#f9f7f3] rounded-lg p-12 mb-12">
              ...
              <p className="font-body text-[#2C3E50] leading-relaxed mb-8">
                We werken hard aan het toevoegen van gedetailleerde informatie over onze kunststof jaloezieën collectie. 
            ...
            <div className="space-y-4">
              <h3 className="font-display text-2xl text-[#2C3E50] font-semibold mb-6">
                Interesse in kunststof jaloezieën?
              </h3>
