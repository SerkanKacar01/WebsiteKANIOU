...
const GordijnrailsSimplePage = () => {
  return (
    <>
      <Helmet>
        <title>Gordijnrails - Professionele Gordijnrails op Maat | Kaniou Zilvernaald</title>
        <meta
          name="description"
          content="Gordijnrails van Kaniou Zilvernaald - hoogwaardige rails voor perfect werkende gordijnen. Ontdek onze collectie gordijnrails met professionele montage."
        />
      </Helmet>
        ...
        <Container>
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbItem>
                <BreadcrumbLink>Gordijnrails</BreadcrumbLink>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </Container>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-[#f9f7f3] rounded-lg p-12 mb-12">
              ...
              <p className="font-body text-[#2C3E50] leading-relaxed mb-8">
                We werken hard aan het toevoegen van gedetailleerde informatie over onze gordijnrails collectie. 
