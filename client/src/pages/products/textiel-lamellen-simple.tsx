...
const TextielLamellenSimplePage = () => {
  return (
    <>
      <Helmet>
        <title>Textiel lamellen - Verticale Textiel Lamellen | Kaniou Zilvernaald</title>
        <meta
          name="description"
          content="Textiel lamellen van Kaniou Zilvernaald - elegante verticale lamellen voor professionele raamoplossingen. Ontdek onze collectie textiel lamellen."
        />
      </Helmet>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-[#f9f7f3] rounded-lg p-12 mb-12">
              ...
              <p className="font-body text-[#2C3E50] leading-relaxed mb-8">
                We werken hard aan het toevoegen van gedetailleerde informatie over onze textiel lamellen collectie. 
