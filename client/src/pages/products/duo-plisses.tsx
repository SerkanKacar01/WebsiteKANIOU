...
const DuoPlissesPage = () => {
  return (
    <>
      <Helmet>
        <title>Duo plissés - Innovatieve Duo Plissé Gordijnen | Kaniou Zilvernaald</title>
        <meta
          name="description"
          content="Duo plissé gordijnen van Kaniou Zilvernaald - de perfecte combinatie van privacy en lichtregulatie. Ontdek onze innovatieve duo plissé collectie."
        />
      </Helmet>
        ...
        <Container>
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbItem>
                <BreadcrumbLink>Duo plissés</BreadcrumbLink>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </Container>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-[#f9f7f3] rounded-lg p-12 mb-12">
              ...
              <p className="font-body text-[#2C3E50] leading-relaxed mb-8">
                We werken hard aan het toevoegen van gedetailleerde informatie over onze duo plissé collectie. 
