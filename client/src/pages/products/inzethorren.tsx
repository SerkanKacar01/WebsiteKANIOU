...
const InzethorrenPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Inzethorren - Made to Measure | KANIOU Zilvernaald</title>
        <meta name="description" content="Discover our made-to-measure Inzethorren, available in various styles and colors. Effective insect protection with professional installation." />
      </Helmet>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-text-light max-w-2xl mx-auto">
                  Discover our made-to-measure Inzethorren, available in various styles and colors. 
                  Effective insect protection that fits perfectly in your window frames.
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-12">
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm border">
                  ...
                  <p className="text-text-light mb-6">
                    Ready to protect your home with custom Inzethorren? 
