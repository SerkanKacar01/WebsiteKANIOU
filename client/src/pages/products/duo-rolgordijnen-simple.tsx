...
const DuoRolgordijnenPage = () => {
  return (
    <>
      <Helmet>
        <title>Duo rolgordijnen - Innovatieve Dag en Nacht Rolgordijnen | Kaniou Zilvernaald</title>
        <meta
          name="description"
          content="Duo rolgordijnen van Kaniou Zilvernaald - perfecte lichtregulatie met transparante en verduisterende banen. Ontdek onze dag en nacht rolgordijnen."
        />
      </Helmet>
        ...
        <Container>
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbItem>
                <BreadcrumbLink>Duo rolgordijnen</BreadcrumbLink>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </Container>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-[#f9f7f3] rounded-lg p-12 mb-12">
              ...
              <p className="font-body text-[#2C3E50] leading-relaxed mb-8">
                We werken hard aan het toevoegen van gedetailleerde informatie over onze duo rolgordijnen collectie. 
