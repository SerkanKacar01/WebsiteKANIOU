        ...
        <div className="relative">
          {isLoading ? (
            ...
            <div className="testimonial-slider">
              <div className="testimonial-slide bg-white p-8 md:p-10 rounded-lg shadow-md mx-4">
          ...
          {testimonials && testimonials.length > 1 && (
            <>
              <div className="absolute top-1/2 left-0 -translate-y-1/2 md:-translate-x-6 z-10">
                <Button
                  size="icon"
                  variant="outline"
                  onClick={goToPrev}
                  className="bg-white text-primary hover:text-accent rounded-full w-10 h-10 flex items-center justify-center shadow-md"
                >
                  <ChevronLeft className="h-6 w-6" />
                </Button>
              </div>

              <div className="absolute top-1/2 right-0 -translate-y-1/2 md:translate-x-6 z-10">
                <Button
                  size="icon"
                  variant="outline"
                  onClick={goToNext}
