...
const RolgordijnenSimplePage = () => {
  return (
    <>
      <Helmet>
        <title>Rolgordijnen - Premium Rolgordijnen op Maat | Kaniou Zilvernaald</title>
        <meta
          name="description"
          content="Rolgordijnen van Kaniou Zilvernaald - praktische en stijlvolle raamdecoratie op maat. Ontdek onze collectie rolgordijnen met professionele montage."
        />
      </Helmet>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-[#f9f7f3] rounded-lg p-12 mb-12">
              ...
              <p className="font-body text-[#2C3E50] leading-relaxed mb-8">
                We werken hard aan het toevoegen van gedetailleerde informatie over onze rolgordijnen collectie. 
