...
const DuoPlissesPage = () => {
  ...
  return (
    <PageLayout
      title="Duo Plissé Gordijnen"
      subtitle="KANIOU Collectie"
      description="Duo plisségordijnen combineren twee stoffen in één systeem: bijvoorbeeld een transparante stof voor overdag en een verduisterende voor 's avonds. Ideaal voor ruimtes waar flexibiliteit en sfeer belangrijk zijn."
      metaDescription="Duo plisségordijnen combineren twee stoffen in één systeem: bijvoorbeeld een transparante stof voor overdag en een verduisterende voor 's avonds. Ideaal voor ruimtes waar flexibiliteit en sfeer belangrijk zijn."
      breadcrumbs={[{ label: "Producten" }, { label: "Duo Plissé" }]}
    >
