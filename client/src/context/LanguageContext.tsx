...
const translations = {
  en: {
    ...
    // Product Categories
    "products.category.curtains": "Curtains",
    "products.category.sheers": "Sheers",
    "products.category.rollerBlinds": "Roller Blinds",
    "products.category.duoRollerBlinds": "Duo Roller Blinds",
    "products.category.verticalTextileBlinds": "Vertical Textile Blinds",
    "products.category.verticalPlasticBlinds": "Vertical Plastic Blinds",
    "products.category.woodenBlinds": "Wooden Blinds",
    "products.category.plasticBlinds": "Plastic Blinds",
    "products.category.textileWindowFilm": "Textile Window Film",
    "products.category.woodenShutters": "Wooden Shutters",
    "products.category.insetScreens": "Inset Screens",
    "products.category.mountedScreens": "Mounted Screens",
    "products.category.pleatScreenDoors": "Pleat Screen Doors",
    "products.category.pleatedBlinds": "Pleated Blinds",
    "products.category.duoPleatedBlinds": "Duo Pleated Blinds",
    "products.category.duoPleatedRoofBlinds": "Duo Pleated Roof Blinds",
    "products.category.roofWindowBlinds": "Roof Window Blinds (Fakro, Velux)",
    "products.category.curtainRails": "Curtain Rails",
    "products.category.curtainRods": "Curtain Rods",
    "products.category.screens": "Screens",
    "products.category.squidFilm": "SQUID Textile Film",
  ...
  nl: {
    ...
    // Product Categories
    "products.category.curtains": "Overgordijnen",
    "products.category.sheers": "Vitrages",
    "products.category.rollerBlinds": "Rolgordijnen",
    "products.category.duoRollerBlinds": "Duo rolgordijnen",
    "products.category.verticalTextileBlinds": "Textiel lamellen",
    "products.category.verticalPlasticBlinds": "Kunststof lamellen",
    "products.category.woodenBlinds": "Houten jaloezieën",
    "products.category.plasticBlinds": "Kunststof jaloezieën",
    "products.category.textileWindowFilm": "Textiel raamfolie",
    "products.category.woodenShutters": "Houten shutters",
    "products.category.insetScreens": "Inzethorren",
    "products.category.mountedScreens": "Opzethorren",
    "products.category.pleatScreenDoors": "Plissé hordeuren",
    "products.category.pleatedBlinds": "Plissé",
    "products.category.duoPleatedBlinds": "Duo plissé",
    "products.category.duoPleatedRoofBlinds": "Duo plissé voor dakramen",
    "products.category.roofWindowBlinds": "Dakraam zonweringen (Fakro, Velux)",
    "products.category.curtainRails": "Gordijnrails",
    "products.category.curtainRods": "Gordijnroedes",
    "products.category.screens": "Horren",
    "products.category.squidFilm": "SQUID textiel folie",
