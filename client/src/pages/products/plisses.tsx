...
const PlissesPage = () => {
  return (
    <>
      <Helmet>
        <title>Plissés - Premium Plissé Gordijnen op Maat | Kaniou Zilvernaald</title>
        <meta
          name="description"
          content="Elegante plissé gordijnen van Kaniou Zilvernaald. Ontdek onze collectie premium plissés op maat met professionele montage en persoonlijk advies."
        />
      </Helmet>
        ...
        <Container>
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbItem>
                <BreadcrumbLink>Plissés</BreadcrumbLink>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </Container>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-[#f9f7f3] rounded-lg p-12 mb-12">
              ...
              <p className="font-body text-[#2C3E50] leading-relaxed mb-8">
                We werken hard aan het toevoegen van gedetailleerde informatie over onze plissé collectie. 
